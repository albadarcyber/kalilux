...
def main_menu():
       clear()
       slowprint(W + '#'*45)
       slowprint(W + '     -== '+gt+'Welcome To Albadar Cyber'+W+' ==-')
       slowprint(W + '#'*45)
       ...
       slowprint (gt+"Daftar Menu:")
       print (gt+"  ["+p+"1"+gt+"] "+p+"Exploiter")
       print (gt+"  ["+p+"2"+gt+"] "+p+"Bot")
       print (gt+"  ["+p+"3"+gt+"] "+p+"Update")
       print (gt+"  ["+p+"0"+gt+"] "+p+"Keluar")
      
    
    
       choice = str(input(C+" albadarcyber==> "))
       exec_menu(choice)
       return
...
def menu_1():
   ...
   os.system('cd Exploiter;python dar.py')

def menu_2():
    slowaprint("Albadar Cyber")
    os.system('cd bot;python dar.py')
def menu_3():
    slowaprint("Albadar Cyber")
    os.system('chmod 777 update.sh;./update.sh')
